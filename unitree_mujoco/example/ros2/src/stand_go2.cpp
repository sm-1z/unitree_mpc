...
public:
    low_level_cmd_sender() : Node("low_level_cmd_sender")
    {
        ...
        state_suber = this->create_subscription<unitree_go::msg::LowState>("/lowstate", 10,
...
private:
    ...
    void LowStateHandler(unitree_go::msg::LowState::SharedPtr msg) {
        imu = msg->imu_state;
        std::cout << "Quaternion: " << imu.rpy[0] << " " << imu.rpy[1] << " "
                  << imu.rpy[2] << " " << imu.rpy[3] << std::endl;
    }

    rclcpp::TimerBase::SharedPtr timer_;                             // ROS2 timer
    rclcpp::Publisher<unitree_go::msg::LowCmd>::SharedPtr cmd_puber; // ROS2 Publisher
    rclcpp::Subscription<unitree_go::msg::LowState>::SharedPtr state_suber; // ROS2 Subscriber
